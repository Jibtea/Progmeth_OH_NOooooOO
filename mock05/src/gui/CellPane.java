...
public class CellPane extends Pane {
    private static final Image WALL_IMG = new Image(ClassLoader.getSystemResource("res/images/wall.png").toString());
    private static final Image DEER_IMG = new Image(ClassLoader.getSystemResource("res/images/deer.png").toString());
    private static final Image SENBEI_IMG = new Image(ClassLoader.getSystemResource("res/images/shika_senbei.png").toString());
    private int row;
    private int col;
