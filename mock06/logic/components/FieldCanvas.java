...
public class FieldCanvas extends Canvas {
	...
	public void spawnDog() {
		 ...
		 * the code below to make dogs responsive.
		 */
...
//				Thread.sleep(15000);
	...
	public void setUpMove() {
		...
		/*
		 * ====================FILL CODE============================ Add something on
		 * the code below to make the cat responsive.
		 */
		Thread t1 = new Thread(() -> {
	...
	public void updateCanvas(GraphicsContext gc) {
		/*
		 * ====================FILL CODE============================ Add something on
		 * the code below to make the game responsive.
		 */
